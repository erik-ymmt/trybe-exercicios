...
describe("Testando a API Cacao Trybe", function () {
  ...
  describe("Usando o método GET em /chocolates/total para buscar a quantidade de chocolates diferentes", function () {
    it("Retorna a quantidade de chocolates", async function () {
      const response = await chai.request(app).get("/total");
